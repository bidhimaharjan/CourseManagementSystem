...
public class RemoveFromModule extends JPanel {
	        		...
	        		try (Connection connection = database.getConnection()) {
	        			if (connection != null) {
	        	            ...
	        	            try (PreparedStatement statement1 = connection.prepareStatement(sql1)) {
	        	                ...
	        	                if (rows1 > 0) {
	        	                	openMessageBox("Instructor removed from the module.");
	        	                } else {
	        	                	openMessageBox("Failed to remove instructor from the module.");
	        	                }
	        	            }
	        			}
